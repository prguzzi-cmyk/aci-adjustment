...
export default async (req, res) => {
	...
	const emailResAdmin = await mailer({
		...
		subject: `Policy Review request from ${req.body.firstName} ${req.body.lastName}`,
		template: 'policy-review',
		context: {
			...req.body,
		},
	});
	...
	const emailRes = await mailer({
		...
		subject: `Policy Review request has been submitted`,
		template: 'policy-review-client',
		context: {
			...req.body,
		},
	});
